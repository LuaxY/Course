<?php
    class DauxHelper {
        ...
        public static function build_directory_tree($dir) {
            return static::directory_tree_builder($dir);
        }
        ...
        private static function directory_tree_builder($dir, $parents = null) {
            if ($dh = opendir($dir)) {
                ...
                while (($entry = readdir($dh)) !== false) {
                    ...
                    if (is_dir($path)) $entry = static::directory_tree_builder($path, $new_parents);
                    else if (in_array($file_details['extension'], array('md', 'markdown')))
                    {
